...
resource "aws_internet_gateway" "internet_gateway" {
  ...
  tags = merge(var.ProjectTags, { Name = "${var.vpcNameTag}-internet_gateway" }, )
}
...
resource "aws_nat_gateway" "nat_gateway" {
  ...
  tags = merge(var.ProjectTags, { Name = "${var.vpcNameTag}-nat_gateway-${count.index}" }, )
}
...
resource "aws_route_table" "private_route_table" {
  ...
  tags = merge(var.ProjectTags, { Name = "${var.vpcNameTag}-rt-${count.index}" }, )
}
